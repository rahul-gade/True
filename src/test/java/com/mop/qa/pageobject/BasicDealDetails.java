...
public void enterDealDetails(RemoteWebDriver driver, String companyName, String trueNorthName, String subSector, String source, String dealSize, String stake, String stakePercent, String mandatory) throws Exception {
	if(i==2){
		mandatory="Yes";
