...
public class TestBlankFinTable extends TestBase {
	private static final Logger LOGGER = Logger.getLogger(TestBlankFinTable.class.getName());
	...
	public void testBlankFinTable() {
		try {
			...
			compFin.fillTable(remoteDriver);
