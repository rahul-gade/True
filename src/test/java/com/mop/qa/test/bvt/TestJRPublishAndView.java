...
public class TestJRPublishAndView extends TestBase {
	private static final Logger LOGGER = Logger.getLogger(TestJRPublishAndView.class.getName());
	@Test
	public void verifyJRDetails() throws Exception  {
	 try{
