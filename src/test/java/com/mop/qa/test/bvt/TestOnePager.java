...
public class TestOnePager extends TestBase {
	...
	public void enterIndustryDetails() throws Exception {
		try {
			...
			cdp.checkDealPageElements(remoteDriver);
			...
			//TO BE REMOVED SOON
//			pager.openSnapshot(remoteDriver);
			//TO BE REMOVED SOON
			pager.enterOnePagerTIC(remoteDriver, competitionWeLike, competitionWeDisLike, industryWeLike,
					industryWeDisLike);
			pager.enterOnePagerIndustry(remoteDriver, competitionWeLike, competitionWeDisLike, industryWeLike,
					industryWeDisLike);
			pager.enterOnePagerCompany(remoteDriver, competitionWeLike, competitionWeDisLike, industryWeDisLike,
					industryWeLike, industryWeLike, industryWeLike);
			pager.enterOnePagerDealDynamics(remoteDriver, competitionWeLike, competitionWeDisLike, competitionWeLike,
					competitionWeLike, competitionWeLike, competitionWeLike);
			pager.entertrueNorthAngles(remoteDriver);
			OnePagerSnapshotPage snap = new OnePagerSnapshotPage(remoteDriver);
			snap.collapseSections(remoteDriver);
			snap.expandSections(remoteDriver);
			snap.navigateTabs(remoteDriver, competitionWeLike, competitionWeDisLike);
