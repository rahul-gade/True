...
public class TestCreateDealAndDelete extends TestBase{
	private static final Logger LOGGER = Logger.getLogger(TestCreateDealAndDelete.class.getName());

	@Test
	public void testCreateDealAndDelte() {
		try {
...
//			System.out.println(flow);
			bDetails.subMitAndDelete(remoteDriver);
		}catch (Exception e) {
			LOGGER.info(e);
		}
	}
