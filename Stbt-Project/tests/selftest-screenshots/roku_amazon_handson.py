...
from pagebase import key_press, BBC_enterText, getText, MatchParameters, Read_Data_CSV, wait_for_motion_detect, passMessageWith_Screenshots, failMessageWith_Screenshots, infoMessage, infoMessageWith_Screenshots, passMessage, failMessage, infoMessage, wait_for_element, match_image, matchText
...
def test_Amazon_HandsOn():
      ...
      """ Opening BBC America Application and Validating BBC Home Page """
      imagePath = Read_Data_CSV(test, "BBC_App_icon_img")
      print (imagePath)
      ...
      sleep(2)
      press("KEY_OK")     
      infoMessageWith_Screenshots ("Clicked on BBC App Icon")
      
      wait_for_element(imagePath, "Home Icon in BBC Home Page", timeout_secs=20)
      sleep(5)
#       to_roku_home()
